...
export default function App() {
  ...
  useEffect(() => {
    const timeout = setTimeout(() => {
      // Android WebView can keep a document in a loading state while a
      // long-lived resource is pending. The page is still usable, so do not
      // hide it behind the native loading overlay indefinitely.
      setLoading(false);
    }, LOAD_TIMEOUT_MS);
